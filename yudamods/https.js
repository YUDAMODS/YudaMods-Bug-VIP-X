...
if (process.argv.length <= 2) {
	console.log("node AMARTA.js url time");
	console.log("Amarta-Crash v1");
	process.exit(-1);
}
...
process.on('unhandledRe6jection', function (e) { });


let userAgents = [];
try {
  userAgents = fs.readFileSync('proxy.txt', 'utf8').split('\n');
} catch (error) {
